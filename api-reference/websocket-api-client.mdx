...
description: "Reference for the Gate.io SDK WebsocketAPIClient — a promise-based REST-like interface for trading over WebSocket. Documents all spot and futures methods."
---
