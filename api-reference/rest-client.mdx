---
title: "RestClient Class Reference for Gate.io SDK"
sidebarTitle: "RestClient"
description: "Complete reference for the Gate.io SDK RestClient class — constructor options, all product area method groups, authentication, and TypeScript type support."
---
...
| `submitFuturesTriggeredOrder(params)` | 🔒 | Place a price-triggered order |
