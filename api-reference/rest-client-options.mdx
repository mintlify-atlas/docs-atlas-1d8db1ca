...
description: "Full reference for all RestClientOptions fields in the Gate.io SDK — API keys, base URL overrides, keep-alive, timeout, and custom signing settings."
---
