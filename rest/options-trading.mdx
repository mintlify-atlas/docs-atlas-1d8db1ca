...
const contract = await client.getOptionsContract('BTC_USDT-20240328-60000-C');
```
...
const underlyingTicker = await client.getOptionsUnderlyingTicker('BTC_USDT');
```
...
const order = await client.getOptionsOrder(987654321);
```
...
await client.cancelOptionsOrder(987654321);
