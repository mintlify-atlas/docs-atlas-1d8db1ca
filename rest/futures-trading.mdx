...
<Tip>
  Use `getFuturesContracts()` for perpetuals and `getDeliveryContracts()` for delivery contracts. The contract name format for delivery includes the expiry date (e.g. `BTC_USDT_20250328`).
</Tip>
