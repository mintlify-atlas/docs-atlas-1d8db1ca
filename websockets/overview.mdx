---
title: "WebSocket Client Overview for Gate.io SDK"
sidebarTitle: "Overview"
description: "The WebsocketClient provides persistent, auto-reconnecting WebSocket connections to Gate.com streams. Learn the core concepts, WsKey system, and event model."
---
...
| `authenticated` | The connection has been authenticated | `{ wsKey }` |
