---
title: "WebSocket API: Trade Over WebSocket on Gate.com"
sidebarTitle: "WebSocket API"
description: "Use Gate.com's WebSocket API to place and cancel orders in real time. Choose between event-driven (sendWSAPIRequest) and promise-based (WebsocketAPIClient) interfaces."
---
